...
var usr1 = listOf(UserReview("sword_robber2",  1679959758, "this game is a lot better than pubg not too much violence"),
UserReview("Acalodo", 1678710558, "This Game is Not that violent and non relistic. The game is fun and should be played by every one."),
    UserRating("J G", 1615638558, 2.5),
    UserRating("Lowkstaa", 1615984158, 4.3),
    UserReview("crispycankles", 1647520158, "I don’t necessarily hate the game just the people who made it, it use to be something great but now I can’t even play 5 minutes of it, it’s not fun anymore, they took all the fun aspects from it by adding crappier weapons in it")
)
    var usr2 = listOf(UserRating("OhRly", 1345552158, 4.0),
    UserReview("Termin8ter", 1499689758, "Counter- Strike: Global Offensive is probably the most popular multiplayer game on PC at the moment, along with last year's Overwatch. What Valve has done with this game, is pretty much take the original Counter Strike, polish and polish it up, add some new features, and release it as this new game. "),
        UserReview("The Escapist", 1347020958, "When it comes down to it, Counter-Strike: Global Offensive may follow the same old formula of gameplay seen in previous versions of Counter-Strike, but it's still a well-rounded tactical shooter."),
        UserReview("danPgaming", 1488198558, "CS:GO with its graphics is moderate, and PC requirements aren't too heavy on the low tier gamer."),
        UserReview("Ndi", 1367497758, "Zero innovation. Same maps, same weapons, only weaker, a bit more graphics and bam, new game.")
    )
    ...
    return listOf(
        ...
        Game(
            "Counter strike: Global offensive", "Xbox One", "August 21, 2012", 9.0, "counter",
            "Mature", "Valve Corporation", " Valve Corporation", "Tactical shooter",
        ...
        Game(
            "Bunny Factory", "Xbox One", "June 2, 2021", 5.5, "bunny",
            "Everyone", "DillyFrame", "DillyFrame", "Puzzle",
            "Help bunny to set up factory production by restoring all control blocks. Solve 3D puzzles alone or with friends.", usr1
        ),
        Game(
            "41 Hours", "PlayStation 5", "May 21, 2021", 6.0, "fourty",
            "Teen", "Texelworks", "Valkyrie Initiative", "Shooter",
            "41 Hours is a first-person shooter dramatic game that follows the narrative of Ethan, a workaholic scientist in search of his long-lost wife.", usr1
        ),
        Game(
...
fun GetDetails(title: String): Game {
    ...
    return game?:Game("Test","Test","Test",0.0,"Test","Test", "Test", "Test", "Test", "Test",usr1)
}